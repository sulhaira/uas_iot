    ...
    <div class="main">
        ...
        <div class="contents">
            <div class="contents-suhu">
              <p>Suhu</p>
             <?php
              $query1 = "SELECT * FROM bedroom WHERE topic = 'control/bedroom/suhu' ORDER BY id DESC LIMIT 1";
            ...
            <div class="contents-kel">
              <p>Kelembaban</p>
              <?php
              $query1 = "SELECT * FROM bedroom WHERE topic = 'control/bedroom/kelembaban' ORDER BY id DESC LIMIT 1";
              $result1 = mysqli_query($conn, $query1);
              $data = mysqli_fetch_array($result1);
              echo $data['payload'];
              ?>
            ...
            <p>LED</p>
            <?php
              $query1 = "SELECT * FROM bedroom WHERE topic = 'control/bedroom/led' ORDER BY id DESC LIMIT 1";
              $result1 = mysqli_query($conn, $query1);
              $data = mysqli_fetch_array($result1);
              if ($data==NULL) {
                echo "No payload";
