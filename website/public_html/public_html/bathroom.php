    ...
    <div class="main">
        ...
        <div class="contents">
            <div class="contents-suhu">
              <p>Suhu</p>
             <?php
              $query1 = "SELECT * FROM bathroom WHERE topic = 'control/bathroom/suhu' ORDER BY id DESC LIMIT 1";
            ...
            <div class="contents-kel">
              <p>Kelembaban</p>
              <?php
              $query1 = "SELECT * FROM bathroom WHERE topic = 'control/bathroom/kelembaban' ORDER BY id DESC LIMIT 1";
              $result1 = mysqli_query($conn, $query1);
              $data = mysqli_fetch_array($result1);
              echo $data['payload'];
              ?>
            ...
            <p>LED</p>
            <?php
              $query1 = "SELECT * FROM bathroom WHERE topic = 'control/bathroom/led' ORDER BY id DESC LIMIT 1";
              $result1 = mysqli_query($conn, $query1);
              $data = mysqli_fetch_array($result1);
              if ($data==NULL) {
                echo "No payload";
