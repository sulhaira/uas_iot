...
void connect() {
  ...
  client.subscribe("control/livingroom/led");
...
void loop() {
 ...
 if ((millis() - timerDHT) > WAKTUDHT) {
   ...
   delay(2000);
    ...
    client.publish("control/livingroom/suhu", msg, true,1); //publish message suhu
    snprintf (msg, MSG_DHT, "%s", itoa(kelembaban,msg,10)); //ubah nilai int ke string
    Serial.print("Kelembaban : ");
    Serial.println(kelembaban);
    client.publish("control/livingroom/kelembaban", msg, true,1); //publish message kelembaban
